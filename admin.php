...
$id_psi = isset($_SESSION['id_psi']) ? $_SESSION['id_psi'] : false;
$nama_admin = isset($_SESSION['nama_admin']) ? $_SESSION['nama_admin'] : false;
?>
        ...
        <div class="row">
            <div class="__header col-md-3 mh-100% bg-info">
                <div class="__header-icon">
                    ...
                    ?>
                    <div class="__header-menu">
                        <?php
                        if ($id_psi) {

                            echo "
                            <a class='coba' href='" . BASE_URL . "admin.php?page=dashboard '>Home<span class='sr-only'>(current)</span></a>
                            </br>
                            <a class='coba' href='" . BASE_URL . "admin.php?page=datamahasiswa'>Data Mahasiswa</a>
                    ...
                    <div class="__footer w-75">
                        <section class="footer-section">
                            <h5 class="__footer-desc">Universitas WON Copyright @
                                <?php
                                echo date('Y') //untuk generate tahun sekarang
                                ?>
                            </h5>
                        </section>
                    </div>
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav">
                                ...
                                if ($id_psi) {
                                    echo "
                                        <li class='nav-item'>
                                        <a class='nav-link text-right' href='" . BASE_URL . "logoutAdmin.php'>Logout <span class='sr-only'>(current)</span></a>
                                        </li>
                                    ";
                                }
                                ?>
